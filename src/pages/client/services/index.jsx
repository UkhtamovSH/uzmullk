...
export default function ServicesPage() {
  ...
  return (
    <div>
      {/* Banner */}
      <section className="relative pt-8 pb-8 sm:pt-[48px] sm:pb-[36.6px] text-center text-white">
        <img
        ...
        <div className="relative container z-10">
          <h1 className="text-lg sm:text-[24px] font-bold mb-3">
            {t("servicesBannerTitle")}
          </h1>
          <p className="text-sm sm:text-[16px] font-medium text-white/80 max-w-2xl mx-auto leading-relaxed">
            {t("servicesBannerDesc")}
          </p>
        </div>
      </section>
