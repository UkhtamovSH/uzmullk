...
const MOCK_RESIDENTS = [
  ...
  { id: 3, name: "Petrova Svetlana Viktorovna",   birthDate: "12.10.1998", regDate: "12.10.1999", regType: "permanent", pinfl: "123456789098765" },
  { id: 4, name: "Ivanov Aleksey Sergeevich",     birthDate: "05.03.1995", regDate: "15.04.2010", regType: "permanent", pinfl: "123456789098765" },
  { id: 5, name: "Madaminova Barno Begzodovna",   birthDate: "12.10.1998", regDate: "12.10.1999", regType: "permanent", pinfl: "123456789098765" },
];
  ...
  return (
    <div className="px-4 sm:px-6 py-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-[22px] font-bold text-[#090A0A]">{t("residentsTitle")}</h2>
